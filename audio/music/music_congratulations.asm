music_congratulations_sq1Routine1:
        ...
        .byte   $02,$B2,$46,$B1,$16,$02,$B2,$46
.if PAL = 1
        .byte   $C2,$B8,$4C,$4C,$BB,$02,$B8,$4C
        .byte   $BB,$02,$FF,$B1,$38,$02,$00
.else
...
.if PAL = 1
        .byte   $4C,$B2,$4C,$4C,$B8,$4C,$4C,$BB
        .byte   $02,$B8,$4C,$BB,$02,$B2,$54,$50
        .byte   $46,$4A,$B4,$4C,$B2,$02,$4C,$4A
        .byte   $48,$B1,$46,$B5,$3C,$B2,$38,$34
        .byte   $B7,$46,$B0,$3C,$B7,$38,$B5,$34
        .byte   $B0,$02,$46,$48,$B1,$4A,$02,$B7
        .byte   $4A,$B0,$48,$B1,$4A,$02,$B7,$4A
        .byte   $B0,$48,$B1,$4A,$02,$B7,$4A,$B0
        .byte   $48,$B2,$4A,$B9,$4A,$4C,$4E,$BB
        .byte   $02,$B2,$50,$4C,$46,$B3,$3E,$B2
        .byte   $46,$4C,$50,$B8,$52,$52,$BB,$02
        .byte   $B8,$52,$BB,$02,$B8,$52,$50,$BB
        .byte   $02,$B8,$4C,$BB,$02,$B1,$50,$02
        .byte   $00
.else
...
.if PAL = 1
        .byte   $07,$FF,$C2,$B9,$04,$04,$04,$BB
        .byte   $01,$B9,$07,$04,$04,$BB,$01,$FF
.else
